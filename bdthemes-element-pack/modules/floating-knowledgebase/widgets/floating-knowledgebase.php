...
class Floating_Knowledgebase extends Module_Base
{
    ...
    protected function register_controls()
    {
        ...
        //         'selectors' => [
        //             '{{WRAPPER}} .floating-help-center__btn .btn' => 'color: {{VALUE}};',
        //         ],
        //     ]
        // );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .floating-help-center__popup .searchbox .searchbox__search-icon' => 'color: {{VALUE}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .floating-help-center__popup .searchbox .searchbox__search-icon' => 'width: {{SIZE}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .floating-help-center__popup .searchbox .searchbox__cross-icon' => 'color: {{VALUE}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .floating-help-center__popup .searchbox .searchbox__cross-icon' => 'width: {{SIZE}}{{UNIT}};',
                ],
