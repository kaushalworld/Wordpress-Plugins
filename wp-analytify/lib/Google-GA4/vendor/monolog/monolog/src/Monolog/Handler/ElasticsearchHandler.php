...
use Analytify\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use Analytify\Monolog\Logger;
use Analytify\Monolog\Formatter\FormatterInterface;
use Analytify\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use Analytify\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use Analytify\Elasticsearch\Client;
use Analytify\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use Analytify\Elastic\Elasticsearch\Client as Client8;
/**
