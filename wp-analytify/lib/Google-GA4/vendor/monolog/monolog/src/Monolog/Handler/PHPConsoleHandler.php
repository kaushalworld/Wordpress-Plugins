...
use Analytify\Monolog\Formatter\LineFormatter;
use Analytify\Monolog\Formatter\FormatterInterface;
use Analytify\Monolog\Logger;
use Analytify\Monolog\Utils;
use Analytify\PhpConsole\Connector;
use Analytify\PhpConsole\Handler as VendorPhpConsoleHandler;
use Analytify\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('Analytify\\PhpConsole\\Connector')) {
