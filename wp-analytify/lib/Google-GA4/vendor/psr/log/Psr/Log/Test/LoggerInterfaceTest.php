...
namespace Analytify\Psr\Log\Test;

use Analytify\Psr\Log\LoggerInterface;
use Analytify\Psr\Log\LogLevel;
use Analytify\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Analytify\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Analytify\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Analytify\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
