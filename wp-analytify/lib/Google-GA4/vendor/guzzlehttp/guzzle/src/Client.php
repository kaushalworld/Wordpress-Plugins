...
use Analytify\GuzzleHttp\Cookie\CookieJar;
use Analytify\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \Analytify\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
