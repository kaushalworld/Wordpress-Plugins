...
\class_alias(\Google\Service\Analytics\Resource\ManagementWebpropertyUserLinks::class, 'Analytify\\Google_Service_Analytics_Resource_ManagementWebpropertyUserLinks');
