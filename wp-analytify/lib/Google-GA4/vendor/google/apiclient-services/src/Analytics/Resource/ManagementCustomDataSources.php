...
\class_alias(\Google\Service\Analytics\Resource\ManagementCustomDataSources::class, 'Analytify\\Google_Service_Analytics_Resource_ManagementCustomDataSources');
