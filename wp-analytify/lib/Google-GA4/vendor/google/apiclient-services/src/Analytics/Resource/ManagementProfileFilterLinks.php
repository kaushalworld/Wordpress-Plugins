...
\class_alias(\Google\Service\Analytics\Resource\ManagementProfileFilterLinks::class, 'Analytify\\Google_Service_Analytics_Resource_ManagementProfileFilterLinks');
