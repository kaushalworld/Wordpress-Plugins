...
use Analytify\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use Analytify\GuzzleHttp\Promise\Promise;
use Analytify\GuzzleHttp\Promise\RejectedPromise;
use Analytify\GuzzleHttp\Psr7\Response;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('Analytify\\GuzzleHttp\\Promise\\Promise')) {
