...
class Module extends Module_Base {
	...
	public function register_controls( $element ) {
		...
		$mscroll_link = Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/settings-not-saved-in-elementor-magic-scroll-addon/', 'editor-page', 'wp-editor', 'get-support' );

		$element->add_control(
			'pa_mscroll_notice',
			array(
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => '<a href="' . esc_url( $mscroll_link ) . '" target="_blank">' . __( 'IMPORTANT: Check this article first!', 'premium-addons-pro' ) . '</a>',
