		...
		<section class="yoast-seo-premium-extension">
			...
			<?php if ( $extension_list->is_installed( $extension->get_title() ) ) : ?>
				...
				<?php if ( $extensions->is_activated( 'wordpress-seo-premium' ) ) : ?>
					<div class="yoast-button yoast-button--noarrow yoast-button--extension yoast-button--extension-activated"><?php esc_html_e( 'Activated', 'wordpress-seo' ); ?></div> <a href="https://www.nulled.ch" target="_blank" class="yoast-link--license">Licensed by Nulled.ch</a> 
