...
class Site_Title extends Widget_Base {
	...
	public function get_name() {
		return 'exad-site-title';
	}

	public function get_title() {
		return esc_html__( 'Site Title', 'exclusive-addons-elementor-pro' );
	}
	...
	protected function register_controls() {
  		...
  		$this->start_controls_section(
			'site_title_section',
			[
				'label' => __( 'Site Title', 'exclusive-addons-elementor-pro' )
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .exad-site-title'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .exad-site-title' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .exad-site-title-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
                    '{{WRAPPER}} .exad-site-title-icon i' => 'font-size: {{SIZE}}{{UNIT}};'
				]
			]
        );
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .exad-site-title-icon i' => 'color: {{VALUE}};'
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .exad-site-title-icon i' => 'margin-right: {{SIZE}}px'
				]
			]
	  	);
	...
	protected function render() {
		...
		?>
		<div class="exad-site-title-wrapper">
			...
			<?php if ( ! empty( $settings['icon']['value'] ) ) : ?>
	          	<span class="exad-site-title-icon">
	    			<?php Icons_Manager::render_icon( $settings['icon'], [ 'aria-hidden' => 'true' ] ); ?>
	          	</span>
			<?php endif; ?>	
			<<?php echo esc_html( $settings['tag'] ); ?> class="exad-site-title">
