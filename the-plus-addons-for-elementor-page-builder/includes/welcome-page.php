		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 12, 2023 <span class="changelog-version">Lite Version 5.2.8</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Added : Post Comment : Add Controller For Dynamic Content','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : Contact Form 7 : Document Link','tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 5, 2023 <span class="changelog-version">Pro Version 5.2.8</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Added : Table : Add Controller For Table Vertical Scrollbar','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Hover card : Opacity Controller Condition Improvement','tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Popup Builder : Outer Click Close Content Issue','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
