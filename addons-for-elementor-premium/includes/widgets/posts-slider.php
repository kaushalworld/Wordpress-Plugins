    ...
    protected function register_controls() {
        ...
        if (lae_fs()->can_use_premium_code__premium_only()) {
            $slider_styles = array(
                ...
                'style-8' => __('Slider Style 8', 'livemesh-el-addons'),
            );
        }
        else {
            $slider_styles = array(
        ...
        if (lae_fs()->can_use_premium_code__premium_only()) {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'return_value' => 'yes',
                    'default' => 'no',
                    'label' => __('Center Mode?', 'livemesh-el-addons'),
                    'description' => __('Enables centered view with partial prev/next slides.', 'livemesh-el-addons'),
                ]
            );
            ...
            $this->add_control(
                'center_padding',
                [
                    'label' => __('Center Padding', 'livemesh-el-addons'),
                    'description' => __('Side padding when in center mode (%).', 'livemesh-el-addons'),
                    'type' => Controls_Manager::NUMBER,
                    'min' => 5,
                    'max' => 25,
                    'step' => 1,
