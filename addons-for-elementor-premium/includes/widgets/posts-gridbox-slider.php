    ...
    protected function register_controls() {
        ...
        if (lae_fs()->can_use_premium_code__premium_only()) {
            $slider_styles = array(
                ...
                'style-4' => __('Slider Style 4', 'livemesh-el-addons'),
                'style-5' => __('Slider Style 5', 'livemesh-el-addons'),
                'style-6' => __('Slider Style 6', 'livemesh-el-addons'),
                'style-7' => __('Slider Style 7', 'livemesh-el-addons'),
            );
        }
        else {
            $slider_styles = array(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 500,
                'condition' => [
                    'slider_style' => ['style-1', 'style-2', 'style-3', 'style-4', 'style-5', 'style-6']
                ]
            ]
        );
        ...
        $this->start_controls_section(
            'section_slider_item_taxonomy_terms',
            [
        ...
        $this->start_controls_section(
            'section_bottom_entry_text_styling',
            [
        ...
        $this->add_control(
            'bottom_entry_terms_hover_color',
            [
        ...
        $this->add_control(
            'bottom_entry_title_hover_color',
            [
                'label' => __('Entry Title Hover Color', 'livemesh-el-addons'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'bottom_entry_meta_link_hover_color',
            [
                'label' => __('Entry Meta Link Hover Color', 'livemesh-el-addons'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
