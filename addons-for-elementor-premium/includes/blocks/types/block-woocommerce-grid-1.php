...
class LAE_Block_WooCommerce_Grid_1 extends LAE_Posts_Block {
    ...
    function inner($posts, $settings) {
        ...
        if (!empty($posts)) {
            ...
            foreach ($posts as $post) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_25($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-grid lae-block-woocommerce-grid lae-block-woocommerce-grid-1 lae-gapless-grid woocommerce';
