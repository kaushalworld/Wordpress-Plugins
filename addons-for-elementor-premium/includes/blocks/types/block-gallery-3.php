...
class LAE_Block_Gallery_3 extends LAE_Gallery_Block {
    ...
    function inner($items, $settings) {
        ...
        if (!empty($items)) {
            ...
            foreach ($items as $item) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_16($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-gallery lae-block-gallery-3 lae-gapless-grid';
