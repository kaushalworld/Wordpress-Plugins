...
class LAE_Block_Grid_6 extends LAE_Posts_Block {
    ...
    function inner($posts, $settings) {
        ...
        if (!empty($posts)) {
            ...
            foreach ($posts as $post) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_13($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-grid lae-block-grid-6 lae-gapless-grid';
