...
class LAE_Block_Twitter_Grid_2 extends LAE_Twitter_Block {
    ...
    function inner($items, $settings) {
        ...
        if (!empty($items)) {
            ...
            foreach ($items as $item) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_18($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-twitter-grid lae-block-twitter-grid-2 lae-gapless-grid';
