...
class LAE_Block_Gallery_2 extends LAE_Gallery_Block {
    ...
    function inner($items, $settings) {
        ...
        if (!empty($items)) {
            ...
            foreach ($items as $item) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_15($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-gallery lae-block-gallery-2 lae-gapless-grid';
