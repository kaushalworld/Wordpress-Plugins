...
class LAE_Block_Instagram_Grid_1 extends LAE_Instagram_Block {
    ...
    function inner($items, $settings) {
        ...
        if (!empty($items)) {
            ...
            foreach ($items as $item) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_22($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-instagram-grid lae-block-instagram-grid-1 lae-gapless-grid';
