...
class LAE_Block_Instagram_Grid_3 extends LAE_Instagram_Block {
    ...
    function inner($items, $settings) {
        ...
        if (!empty($items)) {
            ...
            foreach ($items as $item) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_24($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-instagram-grid lae-block-instagram-grid-3 lae-gapless-grid';
