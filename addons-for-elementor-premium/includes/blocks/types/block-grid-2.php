...
class LAE_Block_Grid_2 extends LAE_Posts_Block {
    ...
    function inner($posts, $settings) {
        ...
        if (!empty($posts)) {
            ...
            foreach ($posts as $post) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_9($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-grid lae-block-grid-2 lae-gapless-grid';
