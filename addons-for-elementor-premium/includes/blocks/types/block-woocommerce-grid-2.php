...
class LAE_Block_WooCommerce_Grid_2 extends LAE_Posts_Block {
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-grid lae-block-woocommerce-grid lae-block-woocommerce-grid-2 lae-gapless-grid woocommerce';
