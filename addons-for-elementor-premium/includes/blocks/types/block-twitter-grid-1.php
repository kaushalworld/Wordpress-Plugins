...
class LAE_Block_Twitter_Grid_1 extends LAE_Twitter_Block {
    ...
    function inner($items, $settings) {
        ...
        if (!empty($items)) {
            ...
            foreach ($items as $item) {
                ...
                $module2 = new \LivemeshAddons\Modules\LAE_Module_17($source);
    ...
    protected function get_block_class() {
        ...
        return 'lae-block-twitter-grid lae-block-twitter-grid-1 lae-gapless-grid';
