...
class LAE_Module_13 extends LAE_Module {
    ...
    function render() {
        ...
        <article
                class="lae-module-13 <?php echo $this->get_module_classes(); ?> <?php echo join(' ', get_post_class('', $source->post_ID)); ?>">
        ...
        return apply_filters('lae_block_module_13', $output, $source);
    }
}