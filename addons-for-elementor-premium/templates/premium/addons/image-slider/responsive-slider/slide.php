<?php
/**
 * Slide - Responsive Slider Template
 *
 * This template can be overridden by copying it to mytheme/addons-for-elementor/premium/addons/image-slider/responsive-slider/slide.php
 *
 */
