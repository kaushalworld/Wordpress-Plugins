<?php
/**
 * Posts Slider Template 4
 *
 * This template can be overridden by copying it to mytheme/addons-for-elementor/premium/addons/posts-slider/style-4.php
 *
 */
                ...
                <?php if (($settings['display_title'] == 'yes') || ($settings['display_taxonomy'] == 'yes') || ($settings['display_summary'] == 'yes')): ?>
                    ...
                    <div class="lae-post-text-wrap">
                        ...
                        <div class="lae-post-text">
                            ...
                            <div class="lae-post-text-overlay"></div>
