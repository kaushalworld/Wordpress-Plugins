<?php
/**
 * Posts Grid Box Slider Template 7
 *
 * This template can be overridden by copying it to mytheme/addons-for-elementor/premium/addons/posts-gridbox-slider/style-7.php
 *
 */
...
$image_height_css = ($image_height) ? 'min-height:' . $image_height . 'px;' : '';
...
<div class="lae-posts-gridbox-slide">
    <div class="lae-posts-gridbox">
        ...
        <div class="lae-posts-gridbox-item lae-<?php echo $settings['text_alignment']; ?>">
                ...
                <?php if ($thumbnail_exists = has_post_thumbnail() && $settings['display_thumbnail'] == 'yes'): ?>
                    ...
                    <?php if ($modulo && $modulo <= 1) : ?>
                        ...
                        <div class="lae-post-overlay lae-post-featured-img-bg"
                             style="background-image: url(<?php echo $image_src; ?>); <?php echo $image_height_css; ?>">
                        ...
                        <?php if ($settings['image_linkable'] == 'yes'): ?>
                            ...
                            <a class="lae-post-link"
                               ...
                               target="<?php echo $target; ?>">
                                <div class="lae-post-featured-img-bg"
