...
* Plugin URI: https://analytify.io/?utm_source=analytify-pro&utm_medium=plugin-uri
...
* Version: 5.0.4
* Author: Analytify
* Author URI: https://analytify.io/?utm_source=analytify-pro&utm_medium=author-uri
* License: GPLv2+
...
define( 'ANALYTIFY_PRO_VERSION', '5.0.4' );

add_action( 'plugins_loaded', 'wp_analytify_pro_load', 15 );
update_option( 'analytify_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_woo_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_edd_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_email_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_campaigns_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_dimensions_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_google_optimize_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_events_tracking_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_goals_license_key','xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx' );
update_option( 'analytify_license_status','valid' );
update_option( 'analytify_woo_license_status','valid' );
...
update_option( 'analytify_dimensions_license_status','valid' );
update_option( 'analytify_google_optimize_license_status','valid' );
update_option( 'analytify_events_tracking_license_status','valid' );
update_option( 'analytify_goals_license_status','valid' );
